 ...
 * - 1.1: Added freertos support | 2026.02.18
 * 
 */
...
#define QMC_USE_FREERTOS true // Set to 1 to enable FreeRTOS delays, 0 for HAL_Delay (blocking)
...
#include "main.h"
    ...
    #include "FreeRTOS.h"
    #include "task.h"
    #define QMC_TaskDelay(ms) vTaskDelay(pdMS_TO_TICKS(ms))
#endif
...
#error "This qmc5883p library can only be used with STM32Cube HAL drivers"
#endif
